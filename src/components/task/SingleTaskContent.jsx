...
export default function SingleTaskContent() {
  ...
  return (
    <div className="p-1 my-2 w-80 ">
      {/* reuseable card */}
      <section className=" bg-base-100 rounded-sm  shadow-xl p-2">
        <div>
          <div className="flex justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <p className="text-[10px] font-semibold">Sadik Istiak</p>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-between py-3">
          <div className="flex items-center space-x-2">
            <p className="text-[10px] text-semibold">
              <svg
          ...
          <p className="flex justify-between items-center  border  bg-slate-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <span className="text-[8px] font-semibold px-2 ">1/2</span>
          </p>
        </div>
        <div className="flex items-center ">
          ...
          <div className="flex items-center space-x-1">
            ...
            <p className=" flex items-center">
              ...
              <span className="text-[10px]">30-12-2022</span>
            </p>
          </div>
        </div>
      </section>
